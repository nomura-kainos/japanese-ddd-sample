...
use 商品カテゴリ\アプリ\ユースケース\詳細表示クエリサービスインターフェース as 商品カテゴリ詳細表示クエリサービスインターフェース;
use 商品カテゴリ\インフラ\リポジトリ\詳細表示クエリサービス as 商品カテゴリ詳細表示クエリサービス;
...
class リポジトリサービスプロバイダ extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
            商品カテゴリ詳細表示クエリサービスインターフェース::class,
            商品カテゴリ詳細表示クエリサービス::class
        );
