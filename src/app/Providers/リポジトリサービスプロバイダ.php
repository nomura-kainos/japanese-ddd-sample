...
use 商品カテゴリ\アプリ\ユースケース\一覧表示クエリサービスインターフェース as 商品カテゴリ一覧表示クエリサービスインターフェース;
use 商品カテゴリ\インフラ\リポジトリ\一覧表示クエリサービス as 商品カテゴリ一覧表示クエリサービス;
use 商品カテゴリ\アプリ\ユースケース\小カテゴリ\一覧表示クエリサービスインターフェース as 商品小カテゴリ一覧表示クエリサービスインターフェース;
use 商品カテゴリ\インフラ\リポジトリ\小カテゴリ\一覧表示クエリサービス as 商品小カテゴリ一覧表示クエリサービス;
...
class リポジトリサービスプロバイダ extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
            商品小カテゴリ一覧表示クエリサービスインターフェース::class,
            商品小カテゴリ一覧表示クエリサービス::class
        );

        $this->app->bind(
            商品カテゴリ一覧表示クエリサービスインターフェース::class,
            商品カテゴリ一覧表示クエリサービス::class
        );
